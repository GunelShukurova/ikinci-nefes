...
const Specialists = () => {
  ...
  const filters = t("specialists_page.filters", { returnObjects: true }) as string[];
  const cards = t("specialists_page.cards", { returnObjects: true }) as SpecialistCard[];
        ...
        <div className="max-w-[1232px] 2xl:max-w-[1400px] w-full mx-auto px-4 py-10 md:py-14">
            ...
            {cards.map((item, index) => (
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-1">
                  ...
                  <p className="text-[#4CAF50] text-sm mt-1">{item.role}</p>
          ...
          <div className="flex justify-end mt-6">
            <button className="text-[#4CAF50] text-[14px] md:text-[16px] font-medium flex items-center gap-2">
              {t("specialists_page.view_all")} <FaArrowRight />
            </button>
          </div>
        </div>
      </section>
